	...
	<view class="content">
		<view class="container" :style='{"width":"100%","padding":"0px","position":"relative","background":"#ffffff","height":"auto"}'>
				...
				<view class="detail-list-item" :style='{"margin":"12rpx 0 12rpx 0","borderColor":"#cccccc","flexWrap":"wrap","borderWidth":"0 0 0px 0","background":"#ffffff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					...
					<view  class="text" :style='{"padding":"0px 0 0 0","margin":"0 0 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#666666","flex":"1"}'>{{detail.zhuangtai}}</view>
				</view>
				...
				<view class="bottom-content bg-white tabbar border shop" :style='{"padding":"0","margin":"20rpx 0 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto"}'>
					...
					<button :style='{"border":"0","padding":"0 20rpx 0 20rpx","margin":"0 20rpx 12rpx 0","color":"#ffffff","borderRadius":"0","background":"#ff746d","width":"auto","fontSize":"28rpx","height":"80rpx"}' @tap="onPayTap" v-if="userid&&isAuth('dingdanxinxi','支付') && detail.ispay!='已支付'"  class="cu-btn bg-brown round shadow-blur">支付</button>
					<button :style='{"border":"0","padding":"0 20rpx 0 20rpx","margin":"0 20rpx 12rpx 0","color":"#ffffff","borderRadius":"0","background":"#ff746d","width":"auto","fontSize":"28rpx","height":"80rpx"}' @tap="onPayTap" v-if="!userid&&isAuthFront('dingdanxinxi','支付') && detail.ispay!='已支付'"  class="cu-btn bg-brown round shadow-blur">支付</button>
					<button :style='{"border":"0","padding":"0 20rpx 0 20rpx","margin":"0 20rpx 12rpx 0","color":"#ffffff","borderRadius":"0","background":"#ff746d","width":"auto","fontSize":"28rpx","height":"80rpx"}' v-if="!isAuth('dingdanxinxi','支付') && detail.ispay!='已支付'" class="cu-btn bg-brown round shadow-blur">未支付</button>
					<button :style='{"border":"0","padding":"0 20rpx 0 20rpx","margin":"0 20rpx 12rpx 0","color":"#ffffff","borderRadius":"0","background":"#ff746d","width":"auto","fontSize":"28rpx","height":"80rpx"}' v-if="detail.ispay=='已支付'"  class="cu-btn bg-brown round shadow-blur">已支付</button>
					<button :style='{"border":"0","padding":"0 20rpx 0 20rpx","margin":"0 20rpx 12rpx 0","color":"#333","borderRadius":"0","background":"#fff000","width":"auto","fontSize":"28rpx","height":"80rpx"}' v-if="userid&&isAuth('dingdanxinxi','完成')" @tap="onAcrossTap('dingdanwancheng','','dingdanzhuangtai','已完成',dingdanzhuangtaiCrossSelect[0])" class="cu-btn bg-brown round shadow-blur" >完成</button>
					<button :style='{"border":"0","padding":"0 20rpx 0 20rpx","margin":"0 20rpx 12rpx 0","color":"#333","borderRadius":"0","background":"#fff000","width":"auto","fontSize":"28rpx","height":"80rpx"}' v-if="!userid&&isAuthFront('dingdanxinxi','完成')" @tap="onAcrossTap('dingdanwancheng','','dingdanzhuangtai','已完成',dingdanzhuangtaiCrossSelect[0])" class="cu-btn bg-brown round shadow-blur" >完成</button>
					<button :style='{"border":"0","padding":"0 20rpx 0 20rpx","margin":"0 20rpx 12rpx 0","color":"#333","borderRadius":"0","background":"#fff000","width":"auto","fontSize":"28rpx","height":"80rpx"}' v-if="userid&&isAuth('dingdanxinxi','取消订单')" @tap="onAcrossTap('dingdanquxiao','','zhuangtai','已取消订单',zhuangtaiCrossSelect[0])" class="cu-btn bg-brown round shadow-blur" >取消订单</button>
					<button :style='{"border":"0","padding":"0 20rpx 0 20rpx","margin":"0 20rpx 12rpx 0","color":"#333","borderRadius":"0","background":"#fff000","width":"auto","fontSize":"28rpx","height":"80rpx"}' v-if="!userid&&isAuthFront('dingdanxinxi','取消订单')" @tap="onAcrossTap('dingdanquxiao','','zhuangtai','已取消订单',zhuangtaiCrossSelect[0])" class="cu-btn bg-brown round shadow-blur" >取消订单</button>
				</view>
			</view>
	...
	export default {
		data() {
			return {
				...
				hasNext: true,
				user: null,
                dingdanzhuangtaiCrossSelect:'已完成,待完成'.split(','),
                zhuangtaiCrossSelect:'已取消订单,已下单'.split(','),
				count: 0,
				timer: null
			}
		},
