...
<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
	<view class="content">
		<view class="container" :style='{"width":"100%","padding":"0px","position":"relative","background":"#ffffff","height":"auto"}'>
				...
				<view class="detail-list-item" :style='{"margin":"12rpx 0 12rpx 0","borderColor":"#cccccc","flexWrap":"wrap","borderWidth":"0 0 0px 0","background":"#ffffff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"auto","padding":"0 20rpx 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}'>完成时间：</view>
					<view  class="text" :style='{"padding":"0px 0 0 0","margin":"0 0 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#666666","flex":"1"}'>{{detail.wanchengshijian}}</view>
				</view>
				<view class="detail-list-item" :style='{"margin":"12rpx 0 12rpx 0","borderColor":"#cccccc","flexWrap":"wrap","borderWidth":"0 0 0px 0","background":"#ffffff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
				...
				<view class="bottom-content bg-white tabbar border shop" :style='{"padding":"0","margin":"20rpx 0 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto"}'>
					...
					<button :style='{"border":"0","padding":"0 20rpx 0 20rpx","margin":"0 20rpx 12rpx 0","color":"#333","borderRadius":"0","background":"#fff000","width":"auto","fontSize":"28rpx","height":"80rpx"}' v-if="userid&&isAuth('dingdanwancheng','评价')" @tap="onAcrossTap('dingdanpingjia','','dingdanzhuangtai','已评价',dingdanzhuangtaiCrossSelect[0])" class="cu-btn bg-brown round shadow-blur" >评价</button>
					<button :style='{"border":"0","padding":"0 20rpx 0 20rpx","margin":"0 20rpx 12rpx 0","color":"#333","borderRadius":"0","background":"#fff000","width":"auto","fontSize":"28rpx","height":"80rpx"}' v-if="!userid&&isAuthFront('dingdanwancheng','评价')" @tap="onAcrossTap('dingdanpingjia','','dingdanzhuangtai','已评价',dingdanzhuangtaiCrossSelect[0])" class="cu-btn bg-brown round shadow-blur" >评价</button>
				</view>
			</view>
	...
	export default {
		data() {
			return {
				...
				hasNext: true,
				user: null,
                dingdanzhuangtaiCrossSelect:'已评价,待评价'.split(','),
				count: 0,
				timer: null
			}
		},
